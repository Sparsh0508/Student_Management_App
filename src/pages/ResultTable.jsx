...
const ResultTable = () => {
  ...
  const fetchResults = async () => {
    try {
      const res = await fetch("https://student-management-app-3bbq.onrender.com/results");
  ...
  const confirmDelete = async () => {
    try {
      await axios.delete(`https://student-management-app-3bbq.onrender.com/results/${deleteId}`);
      setOpenDelete(false);
      fetchResults();
    } catch (err) {
      console.log(err);
  ...
  //   const res = await fetch("https://student-management-app-3bbq.onrender.com/students");
  //   const data = await res.json();
  //   setStudents(data);
  // };
              ...
              {filteredResults.map((r) => (
                <tr key={r.id}>
                  ...
                  <td>
                    ...
                    <button className="delete-btn" onClick={() => { setDeleteId(r.id); setOpenDelete(true); }}>
                      Delete
                    </button>
                  </td>
                </tr>
